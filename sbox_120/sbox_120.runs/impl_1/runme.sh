...
HD_PWD='C:/Users/Utkarsh/Documents/sbox_120/sbox_120.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Sbox_r.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Sbox_r.tcl -notrace
