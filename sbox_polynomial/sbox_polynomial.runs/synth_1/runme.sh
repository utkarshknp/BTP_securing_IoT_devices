...
HD_PWD='C:/Users/Utkarsh/Documents/sbox_polynomial/sbox_polynomial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_x_inv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_x_inv.tcl
