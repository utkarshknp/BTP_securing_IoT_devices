...
HD_PWD='C:/Users/Utkarsh/Documents/sbox_polynomial/sbox_polynomial.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_x_inv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul_x_inv.tcl -notrace
