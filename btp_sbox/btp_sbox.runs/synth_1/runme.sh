...
HD_PWD='C:/Users/Utkarsh/Documents/btp_sbox/btp_sbox.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sbox.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sbox.tcl
