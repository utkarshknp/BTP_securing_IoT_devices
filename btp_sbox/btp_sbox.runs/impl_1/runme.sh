...
HD_PWD='C:/Users/Utkarsh/Documents/btp_sbox/btp_sbox.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sbox.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sbox.tcl -notrace
