...
HD_PWD='C:/Users/Utkarsh/Documents/AES_pipeline/AES_pipeline.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log testbenc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbenc.tcl
