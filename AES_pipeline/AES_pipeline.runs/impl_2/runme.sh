...
HD_PWD='C:/Users/Utkarsh/Documents/AES_pipeline/AES_pipeline.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log testbenc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testbenc.tcl -notrace
