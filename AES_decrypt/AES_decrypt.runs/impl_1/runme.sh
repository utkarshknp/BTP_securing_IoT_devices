...
HD_PWD='C:/Users/Utkarsh/Documents/AES_decrypt/AES_decrypt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_decryption.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_decryption.tcl -notrace
