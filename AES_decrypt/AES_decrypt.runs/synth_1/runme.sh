...
HD_PWD='C:/Users/Utkarsh/Documents/AES_decrypt/AES_decrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_decryption.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aes_decryption.tcl
