...
HD_PWD='C:/Users/Utkarsh/Documents/AES_merged/AES_merged.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log roundnum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source roundnum.tcl
