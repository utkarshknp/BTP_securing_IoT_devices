...
HD_PWD='C:/Users/Utkarsh/Documents/AES_merged/AES_merged.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log roundnum.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source roundnum.tcl -notrace
