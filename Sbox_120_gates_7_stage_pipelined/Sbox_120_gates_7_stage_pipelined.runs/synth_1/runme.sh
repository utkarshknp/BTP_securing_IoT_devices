...
HD_PWD='C:/Users/Utkarsh/Documents/Sbox_120_gates_7_stage_pipelined/Sbox_120_gates_7_stage_pipelined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sbox_r.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sbox_r.tcl
